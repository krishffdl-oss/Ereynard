...
function ClientCard({ client, delay = 0 }) {
  ...
  return (
    ...
    >
      <img src={client.img} alt={client.name} loading="lazy" decoding="async" style={{
...
export default function ClientsPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Our Clients — 200+ Brands Scaled | Ereynard Digital Marketing Agency</title>
        <meta name="description" content="Ereynard ne 200+ Indian brands ko scale kiya hai — E-Commerce, SaaS, EdTech, Fashion, Fintech aur D2C. 98% client retention, 10x ROI, 340% sales growth. India's sharpest digital marketing agency, Udaipur." />
        <meta name="keywords" content="ereynard clients, digital marketing clients india, brands scaled india, performance marketing results, ereynard portfolio, marketing agency udaipur, client testimonials india" />
        ...
        <meta property="og:title" content="Our Clients — 200+ Brands Scaled | Ereynard" />
        <meta property="og:description" content="200+ Indian brands trust Ereynard for digital growth. 98% client retention, real results across E-Commerce, SaaS, EdTech, Fashion & more. India's sharpest digital agency." />
        ...
        <meta name="twitter:title" content="Our Clients — 200+ Brands Scaled | Ereynard" />
        <meta name="twitter:description" content="200+ Indian brands trust Ereynard. 98% retention, 10x ROI, 340% sales. India's sharpest digital marketing agency." />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "description": "Ereynard has scaled 200+ Indian brands across E-Commerce, SaaS, EdTech, Fashion, Fintech and D2C with 98% client retention.",
